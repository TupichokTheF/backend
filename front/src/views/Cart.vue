    ...
    <div class="container">
      ...
      <div v-else class="cart-content">
        ...
        <div class="cart-summary">
          ...
          <button class="checkout-btn" :disabled="orderLoading" @click="makeOrder">
...
export default {
  ...
  methods: {
    ...
    async makeOrder(retry = true) {
      if (this.cartItems.length === 0) {
        this.orderError = 'Корзина пуста. Добавьте товары перед оформлением заказа.'
        return
      }
      ...
      try {
        ...
        this.orderError = error.message || 'Не удалось оформить заказ. Попробуйте снова.'
      } finally {
